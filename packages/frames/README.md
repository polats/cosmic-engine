...
3. Open [http://localhost:3002](http://localhost:3002) with your browser to see the result.

4. Edit `app/page.tsx`

5. Visit [http://localhost:3002/debug](http://localhost:3002/debug) to debug your frame.
